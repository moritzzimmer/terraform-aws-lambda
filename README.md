...
| <a name="input_snap_start"></a> [snap\_start](#input\_snap\_start) | Whether to enable AWS Lambda snapstart capability. (Only available for Java runtimes and x86\_64 architectures.) | `bool` | `null` | no |
